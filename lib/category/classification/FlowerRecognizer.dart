...
class _HomeState extends State<FlowerRecognizer> {
  List _outputs;
  File _image;
  bool _loading = true;
  final picker = ImagePicker();
  final _title = "Flower Recognizer";
  final _asset = 'assets/models/FlowerRecognizer/flower.png';
  final _description = "Identify Which kind of flower is this";
  final _model = "assets/models/FlowerRecognizer/model.tflite";
  final _labels = "assets/models/FlowerRecognizer/labels.txt";
